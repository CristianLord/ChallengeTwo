...
export class UsersService extends BaseService {
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUsersGetWoutSubscIdUserGet$Plain()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersGetWoutSubscIdUserGet$Plain$Response(params: {
    idUser: number;
    context?: HttpContext
  }
): Observable<StrictHttpResponse<Array<UserViewModel>>> {

    const rb = new RequestBuilder(this.rootUrl, UsersService.ApiUsersGetWoutSubscIdUserGetPath, 'get');
    if (params) {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiUsersGetWoutSubscIdUserGet$Plain$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersGetWoutSubscIdUserGet$Plain(params: {
    idUser: number;
    context?: HttpContext
  }
): Observable<Array<UserViewModel>> {

    return this.apiUsersGetWoutSubscIdUserGet$Plain$Response(params).pipe(
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUsersGetWoutSubscIdUserGet$Json()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersGetWoutSubscIdUserGet$Json$Response(params: {
    idUser: number;
    context?: HttpContext
  }
): Observable<StrictHttpResponse<Array<UserViewModel>>> {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiUsersGetWoutSubscIdUserGet$Json$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUsersGetWoutSubscIdUserGet$Json(params: {
    idUser: number;
    context?: HttpContext
  }
): Observable<Array<UserViewModel>> {

    return this.apiUsersGetWoutSubscIdUserGet$Json$Response(params).pipe(
      map((r: StrictHttpResponse<Array<UserViewModel>>) => r.body as Array<UserViewModel>)
    );
  }
